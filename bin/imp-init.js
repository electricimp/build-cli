...
program
    ...
    .on("--help", function() {
        console.log("  Usage:");
        console.log("");
        console.log("    imp init -g\t\tAgent and device code files will not be overwritten");
        console.log("    imp init -k\t\tAgent and device code files will not be overwritten");
        console.log("    imp init -k device\tDevice code file will not be overwritten");
        console.log("    imp init -k agent\tAgent code file will not be overwritten");
    });
